...
# C99 mode is needed
SET(CMAKE_C_FLAGS "${CMAKE_C_FLAGS} -std=gnu99 -D_REENTRANT -D__PLUGIN__ -D_THREAD_SAFE -D_FILE_OFFSET_BITS=64")
...
#Adds plugins folder to the include
set(LIBVLC_INCLUDE_DIR ${LIBVLC_INCLUDE_DIR} ${LIBVLC_INCLUDE_DIR}/plugins)
